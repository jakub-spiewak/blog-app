...
import {Box, Center, Container, Divider, Spacer, Text} from "@chakra-ui/react";
        ...
        <Box as={"main"} className={styles.container} id={"landingPageContainer"}>
            ...
            <Center as={"section"} className={`${styles.section} ${gradientStyles.background}`}>
                <Container className={styles.aboutMe}>
                    ...
                    <p>
                        I&apos;m a fullstack developer with passion for what I do! I&apos;ve started my programming adventure
                    ...
                    <Divider m={4}/>
                    <p>
                        I cooperate with CodeLab on a daily basis, but when I finish my duties I start to develop my own projects.
                        I deliver projects for my private clients, spend time expanding my current knowledge and trying
                        new technologies and trends.
                    </p>
                    <Divider m={4}/>
                    <p>
                        I like the role of a fullstack dev because I have an impact on the software, both on what the user sees
                        and doesn&apos;t see.
                    </p>
                </Container>
            </Center>
